...
<html>
	...
	<body>
		...
		<div align="center" id="page_creation_projet" class="form">
		...
		<br /><br />
			<form method="POST" action="">
				...
				<tr>
					<td></td>
					<td align="center">
						<input type="submit" id="button_orange_creation" class="button" value ="Je crée mon projet" name="forminscription"/>
					</td>
				</tr>
			</table>
		</form>
